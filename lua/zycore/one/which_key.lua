...
local mappings = {
  ...
  ['S'] = { '<cmd>lua require("telescope").extensions.live_grep_args.live_grep_args() theme=ivy<cr>', 'Find Text with args' },
  ...
  g = {
    ...
    f = { '<cmd>lua _GITUI_TOGGLE()<CR>', 'GitUI' },
